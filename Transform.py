...
if __name__ == "__main__":
    ...
    R = R_z @ R_y @ R_x  # First rotate around X, then around Y, then around Z
    transformed_points = points@R.T

    # Small translation
    # translation = 0.01
    translation = np.random.normal(scale=10.0, size =(1,3))
    transformed_points = transformed_points + translation

    #Noise
    #noise  = np.random.normal(scale=0.1, size =(transformed_points.shape[0],3))
